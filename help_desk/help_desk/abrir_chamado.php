...
<body>
  ...
  <div class="container">
              ...
              <div class="col">
                ...
                <form method="POST" action="registra_chamado.php">
                  ...
                  <div class="row mt-5">
                    ...
                    <div class="col-6">
                      <button class="btn btn-lg btn-outline-info btn-block" type="submit">Abrir</button>
                    </div>
                  </div>
                </form>
    ...
    <footer class="bg-body-tertiary text-center text-lg-start fixed-bottom bg-dark " style="color:white;">
